...
var shi = [];
for(var i = 0,len1 = province.length;i<len1;i++){
	shi[province[i]] = city[i];
//	console.log(province[i]+"="+shi[province[i]]);
}
//console.log("************************************************");
var qu = [];
for(var j = 0,len2 = city.length;j<len2;j++){
	for(var k = 0,len3 = city[j].length;k<len3;k++){
		qu[city[j][k]] = district[j][k];
//		console.log(city[j][k]+"="+qu[city[j][k]]);
	}
}
//angular.module("myapp",[]).controller("myctrl",function($scope){
//	$scope.provinces=province;
//	$scope.changeCity=function(){
//		$scope.citys=shi[$scope.selectedProvince];
//	}
//	$scope.changeArea=function(){
//		$scope.areas=qu[$scope.selectedCity];
//	}
//	$scope.$watch("selectedProvince",$scope.changeCity,true);
//	$scope.$watch("selectedCity",$scope.changeArea,true);
//})
